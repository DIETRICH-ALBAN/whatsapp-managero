        ...
        <section id="features" className="py-16 sm:py-20 lg:py-24 bg-background-deep relative overflow-hidden">
            <div className="container mx-auto px-4 sm:px-6 z-10 relative">
                ...
                <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-12 lg:mb-16">
                    ...
                    <p className="text-foreground-muted text-base sm:text-lg px-4 sm:px-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {features.map((f, i) => (
                        ...
                        >
                            <div
                                className="group relative h-full p-[1px] rounded-2xl bg-gradient-to-b from-border to-transparent hover:from-primary/50 hover:to-secondary/50 transition-all duration-500"
                            >
                                <div className="absolute inset-0 bg-card rounded-2xl m-[1px] z-0" />
                                <div className="relative z-10 p-5 sm:p-8 h-full flex flex-col items-start bg-card/50 backdrop-blur-sm rounded-xl hover:bg-card/80 transition-colors">

                                    <div className={`p-3 rounded-lg bg-background-deep/50 mb-6 ${f.color} group-hover:scale-110 transition-transform duration-300 ring-1 ring-white/10 dark:ring-white/5`}>
